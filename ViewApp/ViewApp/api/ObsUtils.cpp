...
{
    obs_properties_t* prop = obs_get_source_properties("game_capture"); //obs_properties_by_id("game_capture");
    if (prop)
    {
...
{
    obs_properties_t* prop = obs_get_source_properties("window_capture");
    if (prop)
    {
        obs_property_t *property = obs_properties_get(prop,"window");
...
{
    obs_properties_t* prop = obs_get_source_properties("dshow_input");
    if (prop)
    {
        //视频设备
...
{
    obs_properties_t* prop = obs_get_source_properties("monitor_capture");
    if (prop)
    {
